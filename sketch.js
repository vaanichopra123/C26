...
function setup() {
  ...
  plArcher = new PlayerArcher ( 340,playerBase.body.position.y - 180,120,120)
  ...
  arrow = new PlayerArrow (370,playerBase.body.position.y - 180,55,25)  
}
...
function draw() {
  ...
  if(keyCode === 32){
    ...
    arrow.shoot(plArcher.body.angle);
